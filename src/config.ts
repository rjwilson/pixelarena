// src/config.ts
import { CharacterConfig, CharacterType, ActionType, DiceRollFn } from './types';

// Simple dice rolling function (d20, d6, etc.)
export const rollDice: DiceRollFn = (sides: number, count: number = 1): number => {
    let total = 0;
...
export const PLAYER_WARRIOR_CONFIG: CharacterConfig = {
    name: "Warrior",
    type: CharacterType.PLAYER,
    stats: {
        maxHp: 30,
        attackPower: 7, // Base damage, attack action will add dice roll
        defense: 4,
        ac: 16,
        speed: 4,       // Can move 4 tiles
        initiativeBonus: 2,
    },
    sprite: { color: "blue", symbol: "W" }, // Simple representation
    actions: [
...
export const PLAYER_MAGE_CONFIG: CharacterConfig = {
    name: "Mage",
    type: CharacterType.PLAYER,
    stats: {
        maxHp: 20,
    ...
    specialAbility: {
        name: "Firebolt",
        type: ActionType.SPECIAL_ABILITY,
        range: 6, // Ranged spell
        description: "Hurl a magical bolt of fire. (Deals 2d6 fire damage)",
        // Effect will be implemented in combat logic
    }
};

export const ENEMY_MELEE_CONFIG: CharacterConfig = {
    name: "Goblin Grunt",
...
export const ENEMY_RANGED_CONFIG: CharacterConfig = {
    name: "Goblin Archer",
    type: CharacterType.ENEMY,
    stats: {
        maxHp: 12,
        attackPower: 4, // For its ranged attack
        defense: 1,
        ac: 12,
        speed: 3,
        initiativeBonus: 2,
...
export const ALL_CHARACTER_CONFIGS: CharacterConfig[] = [
