...
export function createCharacter(
    ...
    const processedActions: GameAction[] = config.actions.map(actionConfig => {
    ...
    if (config.specialAbility) {
        const special: GameAction = {
            ...config.specialAbility,
            damage: () => { // Example damage for special abilities
 ...
 */
export function moveCharacter(character: Character, newPosition: GridPoint, grid: GridTile[][]): void {
 ...
 */
export function applyDamage(character: Character, amount: number): number {
 ...
 */
export function resetCharacterTurnActions(character: Character): void {
